...
<main role="main">
	...
	<section class="jumbotron text-center mt-3">
		<div class="container">
			...
			Destinasi Wisata di Kabupaten <?php echo e($kabupaten->name); ?>
			...
			<div class="col-md-12 mt-1 mb-4">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb bg-ligt">
						...
						<li class="breadcrumb-item active" aria-current="page"><?php echo e($kabupaten->name); ?></li>
					</ol>
				</nav>
			</div>
		</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('template.frontend.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\objekwisata\resources\views/homepage/getContentKabupaten.blade.php ENDPATH**/ ?>