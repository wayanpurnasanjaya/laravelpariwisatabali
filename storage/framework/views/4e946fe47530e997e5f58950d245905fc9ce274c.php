		...
		<div class="row">
			<div class="col-md-12 mb-5">
				<div class="float-right">
					<a href="<?php echo e(route('otherContent')); ?>" class="btn btn-info"> >>> Other Content</a>
				</div>
			</div>
		</div>
	</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('template.frontend.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\objekwisata\resources\views/homepage/index.blade.php ENDPATH**/ ?>