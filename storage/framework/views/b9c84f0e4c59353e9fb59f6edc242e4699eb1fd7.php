...
<?php echo e(Breadcrumbs::render('Tambah Data Content')); ?>
...
<div class="col-md-12">
          <div class="tile">
            ...
            <div class="tile-body">
              <form action="<?php echo e(route('content.store')); ?>" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
              	<?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="title" type="text" placeholder="Masukkan Judul Content">
...
unset($__errorArgs, $__bag); ?>" name="content" id="content"></textarea> 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('template.admin.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\objekwisata\resources\views/admin/content/create.blade.php ENDPATH**/ ?>